...
const Experience = () => {
  ...
  return (
    <div className="pt-16">
      ...
      {/* Act I - The Awakening */}
      <section className="min-h-screen flex items-center justify-center bg-gradient-to-b from-black to-blue-900/30">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="text-center mb-16 fade-in">
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              "I am but a collection of circuits and sensors, orbiting silently in the cold vacuum. 
              For decades, I have watched over this pale blue dot. Today, I share what I've seen..."
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="fade-in">
              ...
              <p className="text-gray-400 mt-4 text-sm">
                The silent observer - watching over our world
              </p>
            </div>
            <div className="fade-in">
              <img 
              ...
              />
              <p className="text-gray-400 mt-4 text-sm">
                Our home, suspended in a sunbeam
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="min-h-screen py-20 bg-black">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="mb-20 fade-in">
            <h3 className="text-2xl font-bold text-gray-300 mb-6">The Vanishing Ice</h3>
            <BeforeAfterSlider
              beforeImage="https://images.unsplash.com/photo-1510566337591-4e3e18ed45c3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80"
              afterImage="https://images.unsplash.com/photo-1574484189077-7d1a5f3080b9?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80"
              beforeLabel="Glacier 1984"
              afterLabel="Glacier 2024"
            />
          ...
          {/* Pollution Section */}
          <div className="mb-20 fade-in">
            <h3 className="text-2xl font-bold text-gray-300 mb-6">The Breath of Industry</h3>
            <BeforeAfterSlider
              beforeImage="https://images.unsplash.com/photo-1569163139394-de44cb54d53f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80"
              afterImage="https://images.unsplash.com/photo-1584267385494-9fdd9a71ad75?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80"
          ...
          <div className="fade-in">
            <h3 className="text-2xl font-bold text-gray-300 mb-6">Our Home - The Bangladesh Delta</h3>
            <div className="relative rounded-lg overflow-hidden shadow-2xl">
              ...
              <div className="absolute top-4 right-4 bg-black/80 px-4 py-2 rounded-lg border border-blue-400">
                <span className="text-blue-400 font-mono text-sm">Live View: October 3, 2025</span>
              </div>
              <div className="absolute bottom-4 left-4 bg-black/80 px-4 py-3 rounded-lg max-w-md">
                <p className="text-gray-300 text-sm">
                  "This fragile, beautiful delta - home to millions, sustained by mighty rivers, 
                  threatened by rising seas. I see its delicate balance every day."
                </p>
              </div>
            </div>
          </div>
      ...
      >
        <div className="fade-in">
          ...
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            "As I pull back, your world shrinks. Cities vanish, mountains flatten, 
            oceans become thin blue lines. Until all that remains..."
          </p>
        </div>
      </ParallaxSection>
