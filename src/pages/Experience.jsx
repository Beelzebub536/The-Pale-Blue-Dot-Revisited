        ...
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="text-center mb-16 fade-in">
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              "I am but a collection of circuits and sensors, orbiting silently
              in the cold vacuum. For decades, I have watched over this pale
              blue dot. Today, I share what I've seen..."
            </p>
          </div>
